...
LOCAL_LDLIBS := -L$(NDK_PLATFORMS_ROOT)/$(TARGET_PLATFORM)/arch-arm/usr/lib -L$(LOCAL_PATH) -lavformat -lavcodec -lavdevice -lswresample -lavutil -lpostproc -lswscale -lx264 -llog -ljnigraphics -lz -ldl -lgcc -lGLESv1_CM -lEGL -lGLESv2  -landroid -fPIC
